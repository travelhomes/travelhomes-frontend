              ...
              <div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                  ...
                  <div onClick={() => handleImageClick("cover")} className="cursor-pointer">
                    <div
                      className={`border border-dashed border-[#EAECF0] rounded-lg aspect-square flex flex-col items-center justify-center text-center bg-[#F9FAFB] hover:bg-[#F0F1F3] transition-colors relative overflow-hidden ${images.cover ? "p-0" : "p-4"
                        }`}
                    >
                      {images.cover ? (
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {["photo1", "photo2", "photo3", "photo4"].map((position, index) => (
                      ...
                      >
                        <div
                          className={`border border-dashed border-[#E7E8E9] rounded-lg aspect-square flex items-center justify-center bg-[#F9FAFB] hover:bg-[#F0F1F3] transition-colors relative overflow-hidden ${images[position] ? "p-0" : "p-4"
                            }`}
                        >
                          {images[position] ? (
