...
export default function Step11({ currentStep, totalSteps }: Step11Props) {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Main content */}
      <div className="flex-grow px-4 sm:px-6 md:px-8 lg:px-[8em] pb-24">
          ...
          <div className="flex flex-col items-center justify-center">
            <div className="w-[890px] mx-auto">
              ...
              <p className="text-center text-[#334054] text-[18px] mb-[50px]">
                ...
                We&apos;ll notify you via email as soon as your listing goes
                live.
              </p>

              {/* What happens next section */}
              <div className="mb-16">
                <h2 className="font-medium text-[24px] text-[#131313] mb-3">
                  What happens next?
                </h2>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <span className="text-black mr-2">•</span>
                    <span className="text-[#334054]">
                      Our team will review your listing within 24-48 hours. In
                      some cases it may take up to seven working days.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-black mr-2">•</span>
                    <span className="text-[#334054]">
                      Once approved, your camper van will be live and ready for
                      bookings.
                    </span>
                  </li>
                </ul>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white px-4 py-4 shadow-[0_-4px_10px_rgba(0,0,0,0.05)]">
        <Link href="/" className="block w-full">
          <Button className="w-full bg-black text-white hover:bg-black/90 rounded-[60px] py-[14px] px-[32px]">
            Back to Home
          </Button>
        </Link>
      </div>
      ...
      <div className="hidden md:flex fixed bottom-0 left-0 right-0 bg-white justify-end items-center border-t border-[#E7E8E9] pt-6 pb-6 px-4 sm:px-6 md:px-8 lg:px-[7rem] shadow-[0_-4px_10px_rgba(0,0,0,0.05)]">
        <div className="flex gap-3">
          ...
          <Link href="/">
            <Button className="bg-black text-white hover:bg-black/90 rounded-[60px] px-6 py-[25px]">
              Back to Home
            </Button>
          </Link>
        </div>
