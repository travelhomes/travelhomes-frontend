...
export default function CamperListing() {
  return (
    <section className="px-4 mt-[3rem] mx-auto max-w-7xl">
          ...
          {isHovered && (
            <>
              ...
              <button
                ...
                className={`absolute right-3 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-white/90 flex items-center justify-center shadow-md transition-all hover:bg-white ${
                  isLastImage
                    ? "opacity-50 cursor-not-allowed"
                    : "hover:scale-105"
                }`}
