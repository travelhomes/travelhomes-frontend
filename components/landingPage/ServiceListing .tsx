export default function ServiceListing() {
    return (
        <div className="md:mx-[5rem] py-8 px-4 md:py-[60px] rounded-2xl md:px-[94px] bg-[url('/bg.png')] bg-cover flex flex-col md:flex-row items-center md:justify-between gap-6">
